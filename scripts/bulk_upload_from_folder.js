...
RELEVANT examples: governing docs (CC&Rs, bylaws, plats, amendments, resolutions, policies), financials (budgets, financial statements, audits, tax returns, AR reports, reserve studies), operational (vendor contracts, vendor invoices, board meeting minutes, board packets, agendas), compliance/legal (violation notices, ACC/ARC decisions, attorney letters, statutory notices, insurance certificates), records (transfer fee requests, estoppels, homeowner correspondence), property (key fob lists, ARC applications, deeds, surveys), insurance (D&O, GL, property).

NOT RELEVANT examples: blank/corrupted scans, personal Ed Gojara files unrelated to HOA work, marketing material from random vendors, junk mail PDFs, broken / mostly-empty pages, old drafts marked-up but never finalized, files that are clearly off-topic.
