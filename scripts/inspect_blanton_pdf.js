// Inspect the BLANTON master plan PDF — bulk-extract failed entirely
...
const PROMPT = `This PDF is a Landmark master plan submittal for DRB Group's BLANTON plan (plan number 1610).
...
Also return:
- plan_name: as printed (e.g. "Blanton")
