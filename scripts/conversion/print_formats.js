...
L.push('- **PENDING_INPUT**: a referenced file or control total has not been supplied.');
L.push('- **UNKNOWN_NAME**: the rule names something that is neither a control code nor a valid measure. This is also recorded as an exception.');
L.push('');
