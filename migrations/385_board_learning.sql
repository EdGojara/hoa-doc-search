...
-- a liability line. Ed 2026-08-25: law firms will not sign off on this, but
-- content grounded in the community's actual governing documents plus Chapter
-- 209 is a reasonable presentation to use WITH a clear standing disclaimer. So:
--   * every surface carries the disclaimer: general education based on the
--     governing documents and Chapter 209, NOT legal advice, and no substitute
...
-- There is no attorney-sign-off workflow: the disclaimer stands in for it.
--
...
COMMENT ON TABLE board_learning_modules IS
  'Board-education modules shown in the board portal. Workpaper (Bedrock IP). General education based on the community''s governing documents and Chapter 209, not legal advice, carried with a standing disclaimer (no attorney-sign-off workflow).';
...
-- ---------------------------------------------------------------------------
-- Seed: six core modules. General Texas HOA governance education, grounded in
-- Chapter 209; specifics always defer to the community's own governing documents
-- and to counsel. Carried with the standing not-legal-advice disclaimer.
-- ---------------------------------------------------------------------------
...
(
  ...
  'Bedrock Association Management. Based on your governing documents and Texas Property Code Chapter 209.',
  10, 4
),
(
