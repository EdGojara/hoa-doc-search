...
function evidenceReadinessGate(pkg) {
  ...
  switch (pkg.readiness) {
    ...
    case 'INCOMPLETE':
      return verdict('NEED_INFO', EXEC.REVIEW, 'EVIDENCE_MISSING', NOTE.DECISION_REQUIRED);
    case 'CONFLICT': // Phase 2 (conflict detection); defined here so the gate is complete
      return verdict('NEED_INFO', EXEC.REVIEW, 'EVIDENCE_CONFLICT', NOTE.DECISION_REQUIRED);
    case 'READY':
    default:
      return null;
  }
