  ...
  "forms": [
    {
      ...
      "resident_type": "owner" | "tenant" | "unknown" — is the applicant the property OWNER or a TENANT/renter? Look for an owner/tenant checkbox or wording; use unknown if not stated,
      "authorized_persons": [
...
function normalizeForm(f) {
  ...
  return {
    ...
    resident_type: ['owner','tenant'].includes(f.resident_type) ? f.resident_type : 'unknown',
