...
const SCREENS = [
...

  {
    ...
    headline: 'I stopped trying to build a better gatekeeper.',
    body: 'Every step here was me realizing the model itself was the problem, not how well I ran it.',
    points: [
      { n: 'First', head: 'A better management company', body: 'When I got into this business, I thought the answer was to run it better than anyone else.' },
      { n: 'Then', head: 'Better software', body: 'When I started trustEd, I thought the answer was better tools for the same model.' },
      { n: 'Now', head: 'A new category', body: 'A true AI management company. Transparency by default, and homeowners and boards with real power, not at the mercy of a gatekeeper.' },
    ],
    footnote: 'The test for everything we build is the same. If it does not make life better for the homeowner or the board, we do not ship it. This was never about monetizing them.',
  },
