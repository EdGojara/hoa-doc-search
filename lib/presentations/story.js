...
const SCREENS = [
  ...
  },
  {
    ...
    body: 'Your network reaches the communities we serve, and we reach communities that would value what you do. Nothing exclusive, nothing complicated — two teams who each make the other more useful to the same neighborhoods. The next step is simple: point business at each other, and pick one thing to build together.',
  },
