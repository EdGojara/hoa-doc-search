...
const SCREENS = [
  ...
  // margin. Threads the trust message into the close. (Ed 2026-09-07.)
  {
    ...
    body: 'We are not here to optimize a margin. We are here to give communities what the industry stopped offering: transparency, education, communication, and trust. Do that well, and the business takes care of itself.',
  },
