...
function build(config = {}, ctx = {}) {
  ...
  // ---------- Slide 5: Six things ----------
  {
    const s = pres.addSlide();
    s.background = { color: COLORS.OFFWHITE };
    addSectionLabel(s, "04 / What we manage for you");
  ...
  // ---------- Slide 6: Senior judgment ----------
  {
    const s = pres.addSlide();
    s.background = { color: COLORS.OFFWHITE };
    addSectionLabel(s, "05 / How we think");
  ...
  // ---------- Slide 7: Compounds ----------
  {
    const s = pres.addSlide();
    s.background = { color: COLORS.OFFWHITE };
    addSectionLabel(s, "06 / It compounds for you");
  ...
  // ---------- Slide 8: Transition ----------
  {
    const s = pres.addSlide();
    s.background = { color: COLORS.OFFWHITE };
    addSectionLabel(s, "07 / What month one looks like");
  ...
  // ---------- Slide 9: Pricing (dark) ----------
  {
    const s = pres.addSlide();
    s.background = { color: COLORS.NAVY_DEEP };
    addSectionLabel(s, "08 / What's included", COLORS.ICE);
