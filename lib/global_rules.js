...
const GLOBAL_RULES = {
  ...
  // -------------------------------------------------------------------------
  tx_force_mow_civil_damages: `The Association reserves the right to pursue any and all further legal remedies, up to and including filing suit to enforce your contractual obligations pursuant to the Declaration. If the Violation is not cured, the Association may seek injunctive relief, recovery of damages, attorney's fees, costs, and other relief available under the Declaration and applicable law. Under Section 202.004(c) of the Texas Property Code, a court may assess civil damages for the violation of a restrictive covenant in an amount not to exceed $200.00 for each day of the violation.`,
