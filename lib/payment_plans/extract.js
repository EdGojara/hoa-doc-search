...

{
  ...
  "plans": [
    {
      "association_name":   "string — the HOA this specific plan belongs to, if the document lists more than one association; else null (falls back to the document-level association_name)",
