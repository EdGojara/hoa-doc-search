...
const BRAND = Object.freeze({
  ...
  // ---------------------------------------------------------------------------
  // Logo file paths — both BAM variants live under /public/logos/. Use the
  // full lockup where the mark needs to breathe (cover heroes, letterheads,
  // invoices); use the minimal wordmark in compact contexts (interior page
  // headers, co-branded lockups next to a community logo).
  // ---------------------------------------------------------------------------
  logos: Object.freeze({
    bamFull:    '/logos/bedrock_logo.png',         // cornerstone + lines + tagline
    bamMinimal: '/logos/bedrock_logo_minimal.png', // wordmark only, wider aspect
  }),
