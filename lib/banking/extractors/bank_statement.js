...

{
  ...
  "account_holder_name":     "string — the account HOLDER / titled name on the statement (usually the HOA/association name, e.g. 'Lakes of Pine Forest Homeowners Association, Inc.'), or empty string",
  "account_name_hint":       "string — the account title/type as printed (e.g. 'Operating Checking', 'Money Market', 'Reserve', 'Savings', 'ICS'), or empty string",
