...
const SEMANTIC_ENDPOINTING_ENABLED = process.env.CLAIRE_SEMANTIC_ENDPOINTING === 'true';
const SEMANTIC_ENDPOINTING_WAIT_MS = Number(process.env.CLAIRE_SEMANTIC_WAIT_MS || 1500);
const BACKCHANNEL_DURING_HOLD = process.env.CLAIRE_BACKCHANNEL === 'true';
