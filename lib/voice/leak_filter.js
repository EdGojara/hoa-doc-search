...
const BANNED_PHRASES = [
  ...
  { pattern: /\bArticle\s+[IVXLCDM]+(?:,?\s+Section\s+\d+(?:\.\d+)*)?\b/g, why: 'verbatim CC&R Article reference in customer voice', severity: 'rewrite', replacement: 'your governing documents' },
  { pattern: /\bSection\s+\d+\.\d+(?:\.\d+)*\b/g, why: 'verbatim Section reference in customer voice', severity: 'rewrite', replacement: 'the applicable rules' },
  { pattern: /\bparagraph\s+\d+(?:\.\d+)*\b/gi, why: 'verbatim paragraph reference in customer voice', severity: 'rewrite', replacement: 'the applicable section' },
