...
function buildOpener(communityName, callerFirstName) {
  ...
  if (callerFirstName && communityName) {
    return `Hi ${callerFirstName} — this is Claire from ${brand}, an AI assistant. Calling about ${communityName}?`;
  }
  if (callerFirstName) {
    return `Hi ${callerFirstName} — this is Claire from ${brand}, an AI assistant. What can I help with?`;
  }
  if (communityName) {
    return `Hi, this is Claire from ${brand} — AI assistant for ${communityName}. What can I help with?`;
  }
  return `Hi, this is Claire from ${brand} — an AI assistant for the property management team. What can I help with?`;
}
