...
function buildOpener(communityName, callerFirstName) {
  ...
  if (callerFirstName && communityName) {
    return `Hi ${callerFirstName}, this is Claire — an AI team member with ${brand} Association Management. I see you're calling from ${communityName}. How can I help?`;
  }
  if (callerFirstName) {
    return `Hi ${callerFirstName}, this is Claire — an AI team member with ${brand} Association Management. How can I help?`;
  }
  if (communityName) {
    return `Thanks for calling ${brand} — this is Claire, an AI team member here. I see you're calling about ${communityName}. How can I help?`;
  }
  return `Hi — this is Claire, an AI team member with ${brand}. How can I help you today?`;
}
