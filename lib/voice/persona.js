...
function buildOpener(communityName, callerFirstName) {
  ...
  if (callerFirstName && communityName) {
    return `Hi ${callerFirstName} — Claire here, an AI team member with ${brand} for ${communityName}. What's going on?`;
  }
  if (callerFirstName) {
    return `Hi ${callerFirstName} — Claire here, an AI team member with ${brand}. What can I help with today?`;
  }
  if (communityName) {
    return `Hi there — Claire here, an AI team member with ${brand} for ${communityName}. What's going on?`;
  }
