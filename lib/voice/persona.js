...
function buildOpener(communityName, callerFirstName) {
  ...
  if (callerFirstName && communityName) {
    return `Hey ${callerFirstName} — this is Claire from ${brand}, an AI assistant. Calling about ${communityName}?`;
  }
  if (callerFirstName) {
    return `Hey ${callerFirstName} — this is Claire from ${brand}, an AI assistant. What can I help with?`;
  }
  if (communityName) {
    return `Hey, this is Claire from ${brand} — AI assistant for ${communityName}. What can I help with?`;
  }
  return `Hey, this is Claire from ${brand} — an AI assistant for the property management team. What can I help with?`;
}
