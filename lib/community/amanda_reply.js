...
// The exception router now lives in lib/team/exception_router.js so the whole
// team shares it, not just Amanda. She feeds it the four signals she computes
// (reserved gate, grounded, escalation, audience); it returns auto_ok vs
// needs_review. Re-exported below so callers/tests keep importing it from here.
const { classifyDisposition } = require('../team/exception_router');
