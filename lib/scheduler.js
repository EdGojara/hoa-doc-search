...
function startScheduler({ logger = console } = {}) {
  ...
  scheduler.register({
    ...
    run: async () => {
      ...
      // Ingest BOTH the intake box (info@) and Claire's own box (claire@) so
      // replies to Claire's outbound show up in Communications, not just Outlook.
      // Comma-separated override via EMAIL_INGEST_MAILBOX.
