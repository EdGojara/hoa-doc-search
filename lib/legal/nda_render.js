...
This Mutual Non-Disclosure Agreement (this "Agreement") is entered into as of {{EFFECTIVE_DATE}} (the "Effective Date") by and between **Bedrock Association Management, LLC**, a Texas limited liability company, on behalf of itself and its affiliates including the trustEd platform ("Bedrock"), and **{{COUNTERPARTY}}** ("Counterparty"). Bedrock and Counterparty are each a "Party" and together the "Parties." Each Party may act as a discloser of its Confidential Information (a "Discloser") and as a recipient of the other Party's Confidential Information (a "Recipient").
...
The Recipient shall not, and shall not permit any third party to, reverse engineer, decompile, disassemble, benchmark, or otherwise attempt to derive the source code, structure, or underlying ideas of any software, system, or platform disclosed or made accessible under this Agreement, nor use any Confidential Information to develop, or assist a third party in developing, a competing product or service.
...
This Agreement is governed by the laws of the State of Texas without regard to its conflict-of-laws rules. The Parties consent to the exclusive jurisdiction and venue of the state and federal courts located in Fort Bend County, Texas.
...
function signatureBlock(fields) {
  ...
  return `<div class="sigs">
    ...
    ${sig(String(fields.counterparty || 'COUNTERPARTY').toUpperCase(), '', '')}
  </div>`;
}
...
function renderNdaHtml(fields = {}, opts = {}) {
  ...
  * { box-sizing: border-box; }
  ...
  <div class="foot">${escapeHtml(BRAND.service.name)} &nbsp;|&nbsp; ${escapeHtml(BRAND.service.addressInline)} &nbsp;|&nbsp; ${escapeHtml(BRAND.service.phone)}</div>
  </body></html>`;
}
