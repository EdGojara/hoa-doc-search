...
const DEFAULT_SECTIONS = [
  ...
  // ---- Board decisions ----------------------------------------------------
  { key: 'legal_referral',   label: 'Accounts recommended for legal referral', group: 'Board Decisions', required: true, source: 'native', owner: 'compliance', confidentiality: 'legal',
    template: { display_name: 'Accounts Recommended for Legal Referral', default_order: 104, required_default: true, supports_manual: true, supports_upload: false, supports_auto_trusted: true, supports_ai_generated: false, default_audience: 'board' } },
