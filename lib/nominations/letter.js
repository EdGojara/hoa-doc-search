...
<div class="other-ways">
  <div class="h">Other ways to submit</div>
  <ul>
    <li><span class="b">Email:</span> info@bedrocktx.com (include nominee name, address, a brief bio, and a photo if available)</li>
    <li><span class="b">Mail:</span> ${escapeHtml(community_name)} HOA, c/o Bedrock Association Management, 12808 West Airport Blvd. #253, Sugar Land, TX 77498</li>
