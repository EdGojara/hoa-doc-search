...
const DEFAULT_EXPECTATIONS = `Board members serve a three-year term. The role is volunteer and typically takes ten to twenty hours a month. The board approves the annual budget, oversees the management agent, and represents the homeowners. Meeting cadence varies by community — some boards meet monthly, some quarterly, some only as needed. If you would like to serve, please submit your nomination.`;
