...
<style>
  ...
  /* Voting instructions — tightened 2026-06 to keep the entire
     voting-instructions page (intro + N method sections + important
     notes + bios callout + TX §209 disclosure) on a SINGLE printed
     page. Long TX §209 text was bleeding onto page 3 once the bios
     callout was added. Every margin/padding here is tuned to make
     that one page hold; loosen only after checking print preview. */
  h3.method-heading {
    color: ${BRAND.colors.navy};
    font-size: 11pt;
    margin: 7px 0 2px;
  ...
  ul.channel-list { margin: 2px 0 3px 22px; padding: 0; font-size: 9.5pt; }
  ul.channel-list li { margin: 1px 0; }
  .deadline-line { color: ${BRAND.colors.navy}; margin: 2px 0 3px; font-size: 10pt; }
  /* Tighter paragraph spacing inside the method sections — the
     standard p margin-bottom 9px above is too airy here. */
  h3.method-heading + p { margin-bottom: 3px; font-size: 10pt; line-height: 1.32; }
  ...
  .important-notes p { margin: 0 0 2px; font-size: 9.5pt; line-height: 1.3; }
  ...
  .tx209-callout .hdr { font-weight: 700; color: ${BRAND.colors.navy}; margin-bottom: 2px; font-size: 9.5pt; }
