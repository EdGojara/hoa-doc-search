...
<style>
  ...
  ul.channel-list { margin: 2px 0 5px 22px; padding: 0; font-size: 10pt; }
  ul.channel-list li { margin: 1px 0; }
  .deadline-line { color: ${BRAND.colors.navy}; margin: 3px 0 5px; }
  /* Tighter paragraph spacing inside the method sections; the
     standard `p { margin: 0 0 9px }` above is too airy here. */
  h3.method-heading + p { margin-bottom: 5px; line-height: 1.35; }
  ...
  .important-notes p { margin: 0 0 3px; font-size: 10pt; line-height: 1.35; }
  ...
  .tx209-callout .hdr { font-weight: 700; color: ${BRAND.colors.navy}; margin-bottom: 2px; font-size: 10pt; }
