...
const COMMUNICATION_RULES = {
  ...
  // ---- ENGAGEMENT-CLASS ----
  // Generally safe. Bankruptcy warning only (extra caution about any
  // contact that could be construed as collection pretext).
  engagement_blast:          { block: [],                                      warn: ['in_bankruptcy'] },
  meeting_notice:            { block: [],                                      warn: ['in_bankruptcy'] },
