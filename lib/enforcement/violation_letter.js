...
async function renderViolationLetterBundlePdf(ctx) {
  ...
  return new Promise((resolve, reject) => {
    ...
    //
    // Sized 2026-06-07: bumped from 24x30 (almost invisible) to 48x60 so
    // Bedrock is a real presence on the letterhead — still smaller than
    // the community logo (Association = principal hierarchy preserved)
    // but actually visible from across a desk.
    const csW = 48, csH = 60;
