  ...
  return new Promise((resolve, reject) => {
    ...
    if (isFirstCo) {
      ...
      if (isSecond) {
        ...
        // Per Ed/ChatGPT review (2026-06-07): soften from 'may proceed to
        // assess fines and recover all reasonable attorney fees' (sounds
        // automatic) to 'may pursue enforcement remedies...where permitted'
        // (sounds discretionary). Same legal effect. Keep the §209.006(e)
        // cure-kills-the-fine sentence — it's homeowner-favorable.
        doc.fillColor(INK).font('Helvetica').fontSize(10.5)
           .text(`If the violation${isMulti ? 's are' : ' is'} cured before this date, no fine may be assessed under Tex. Prop. Code §209.006(e). If not cured by this date, the Association may pursue enforcement remedies authorized by the governing documents and applicable law, including the assessment of fines and recovery of attorney fees and costs where permitted.`,
                 PAGE.margin, y, { width: contentWidth, lineGap: 2 });
        y = doc.y + 6;
