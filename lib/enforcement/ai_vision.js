...
- Pick the ONE category that best fits what you actually see. The category MUST match the photo:
    ...
    · Tall, shaggy, or overgrown grass across the lawn, yard, or curb strip is a LAWN-HEIGHT violation (mow_and_edge, or lawn_height) — that is the primary issue. "Grass in the expansion joints" is a NARROW, minor category reserved ONLY for grass or weeds sprouting up THROUGH the concrete seams, joints, or cracks of the driveway, sidewalk, or curb — not for a tall lawn. Do NOT pick expansion-joints when the actual problem is that the lawn itself needs mowing. When the lawn is overgrown AND there is some grass in the joints, the overgrown lawn is the more significant violation — pick the lawn-height category.
