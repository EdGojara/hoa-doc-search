// ============================================================================
// ai_vision.js — categorize an inspection photo with Claude vision
// ----------------------------------------------------------------------------
...
//
// Critical guardrails:
//   - System prompt instructs Claude to write in Bedrock voice (conversational,
...
//   - Output is strict JSON; failures (Claude returns prose, network error)
...
async function categorizePhoto(input) {
  ...
  try {
    ...
    console.error('[ai_vision] Claude call failed:', err.message);
    return null;
  }
}
