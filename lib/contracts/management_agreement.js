...
<div class="signatures">
  ...
  <div class="sig-col">
    <div class="sig-line"></div>
    <div class="sig-label">For Bedrock Association Management, LLC</div>
    <div class="sig-fields">
      <div>Name: ____________________________</div>
      <div>Title: ____________________________</div>
      <div>Date: ____________________________</div>
...
async function renderManagementAgreementHTML({
  ...
  const tokens = {
    ...
    bedrock_legal_name: 'Bedrock Association Management, LLC',
    bedrock_address: '12808 West Airport Blvd., Suite 253, Sugar Land, TX 77498',
...
<style>
  ...
  .head .parties { font-size: 13pt; font-weight: 700; color: #1E2761; }
  ...
  table.rate-table th {
    ...
    text-transform: uppercase;
    border-bottom: 1.5px solid #1E2761;
    padding: 5px 8px;
  }
...
<div class="head">
  ...
  <div class="sub">and Bedrock Association Management, LLC</div>
</div>
