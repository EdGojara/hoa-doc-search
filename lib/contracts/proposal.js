...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ===== COVER ===== */
  .cover {
    background: linear-gradient(135deg, ${BRAND.colors.navy} 0%, #2a3a8f 100%);
    color: #fff;
    padding: 0;
    display: flex;
...
<div class="page cover">
  <div class="cover-top">
    ${bedrockLogo
      ...
      : `<div style="font-size:32pt; font-weight:800; letter-spacing:1px;">BEDROCK</div>
         <div style="font-size:9pt; letter-spacing:3px; color:${BRAND.colors.gold}; font-weight:600; margin-top:2px;">ASSOCIATION MANAGEMENT</div>`}
  ...
  <div class="cover-bottom">
    <div>
      ...
      <div style="font-size:9pt; color:rgba(255,255,255,0.75); margin-top:4px; line-height:1.55;">Owner, ${BRAND.service.name}<br>Founder, ${BRAND.tech.name} &amp; trustEd</div>
      <div style="font-size:8.5pt; color:rgba(255,255,255,0.6); margin-top:6px;">${fmtDate(proposalDate)}</div>
    </div>
    <div class="contact">
      ${BRAND.service.legal}<br>
      ${BRAND.service.addressInline}<br>
      ${BRAND.service.phone} &nbsp;·&nbsp; ${BRAND.service.email} &nbsp;·&nbsp; ${BRAND.service.website}
    </div>
  </div>
</div>
...
<div class="page">
  <div class="pg-header">
    <div>
      ${bedrockLogo ? `<img src="${bedrockLogo}" alt="Bedrock">` : `<strong style="color:${BRAND.colors.navy}; font-size:14pt;">BEDROCK</strong>`}
    </div>
    <div class="community-tag">${escapeHtml(communityName)} · Proposal</div>
  </div>

  <div class="section-kicker">Why Bedrock</div>
  <h1 class="section">We don't outsource judgment.<br>Yours gets ours, every time.</h1>
  <p class="lede">
  ...
  <p>
    The result for your community is not a "we care about people" pitch. It is a management approach designed around the patterns that quietly hurt other boards — surfacing them early, documenting decisions clearly, and keeping the recurring obligations of an association on schedule.
  </p>
  ...
  <div class="qual-grid">
    ...
    <div class="qual-card">
      <div class="label">Process Discipline</div>
      <div class="value">A board issue that surfaces once gets resolved once. We document what happened, why, and what we changed — so the same problem does not have to come back to your board twice.</div>
    </div>
    <div class="qual-card">
  ...
  <div class="quote">
    ...
    <div style="margin-top:6px; font-style:normal; font-size:9.5pt; color:${BRAND.colors.navy}; font-weight:700;">— Edward Gojara</div>
  </div>

  <div class="pg-footer">
    <span>${BRAND.service.legal}</span>
...
<div class="page">
  ...
  <div class="pillar-grid">
    <div class="pillar">
      <h3>askEd — plain-English answers about your community</h3>
      <p>Ask a question about your community's Bylaws, CC&amp;Rs, ARC guidelines, or prior board minutes — get a direct answer with the section cited. Questions that used to take a board member three days of email back-and-forth get answered in seconds.</p>
    </div>
    <div class="pillar">
    ...
    <div class="pillar">
      <h3>Response times measured, not estimated</h3>
      <p>Each owner contact, ARC application, vendor request, and board task is timestamped from start to resolution. Service quality is measurable per community — not anecdotal, not "we feel like we're doing fine."</p>
    </div>
    <div class="pillar">
      <h3>Decisions come with thinking already done</h3>
      <p>Significant board recommendations reach you with the reasoning behind them. Homeowner impact, financial impact, governance considerations — surfaced and noted before the vote, not after.</p>
    </div>
  </div>

  <p style="margin-top:18px;">
    trustEd is included in your monthly management fee. There is no separate technology charge. The result for ${escapeHtml(communityName)}: a consistent process, clearly documented decisions, and a permanent record the board can rely on.
  </p>
...
<div class="page">
  ...
  <p style="margin-top:30px; margin-bottom:2px;"><strong style="color:${BRAND.colors.navy};">Edward Gojara</strong></p>
  <p style="margin:0; font-size:10pt; color:#475569;">Owner, ${BRAND.service.legal}<br>Founder, ${BRAND.tech.name} &amp; trustEd<br>${BRAND.service.phone} &nbsp;·&nbsp; ${BRAND.service.email}</p>
