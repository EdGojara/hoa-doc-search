...
const TEAM_INGEST_MAILBOXES = [
  ...
  // violations@ -> Miranda, accounting@ -> Kat. (acc@/builders@/arc@ don't exist —
  // ACC mail routes to Annie by classification instead.)
  'violations@bedrocktx.com', 'accounting@bedrocktx.com',
];
