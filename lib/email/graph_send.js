...
const AMANDA_MAILBOX = process.env.AMANDA_MAILBOX || 'amanda@bedrocktx.com';  // Senior Community Manager — escalation tier for tough/cross-domain issues (Amanda Albright)
