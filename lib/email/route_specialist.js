...
// Titles/names mirror persona.js TEAM so the hand-off card matches the board.
const SPECIALISTS = {
  miranda: { name: 'Miranda Pierce',  title: 'Compliance / DRV' },
  annie:   { name: 'Annie Reeves',    title: 'ACC / ARC' },
  reese:   { name: 'Reese Calloway',  title: 'Resale / estoppels' },
  paige:   { name: 'Paige Chandler',  title: 'Board operations' },
  kat:     { name: 'Kat Reed',        title: 'Accounting' },
};
