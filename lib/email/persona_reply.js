...
async function draftPersonaReply({ persona, email, context = {}, notes = null, currentDraft = null, examples = null }) {
  ...
  // Name and title come from the roster so this file cannot drift from the
  // signature block that gets appended to whatever it writes.
  if (p && !p.name) Object.assign(p, personaIdentity(persona));
