  ...
  <table cellpadding="0" cellspacing="0" role="presentation" style="margin-top:18px;border-top:2px solid ${GOLD};padding-top:12px;font-family:Arial,Helvetica,sans-serif;">
    <tr>
      <td style="font-size:13px;line-height:1.5;color:${NAVY};">
        ...
        <span style="color:${MUTED};">Accounting</span><br>
    ...
    <tr>
      <td style="padding-top:12px;font-size:11px;color:${MUTED};max-width:420px;">I'm Bedrock's AI team member on accounting, so I can get you answers fast. Need a person? Just reply and I'll pass you to the team.</td>
    </tr>
  </table>`;
}
