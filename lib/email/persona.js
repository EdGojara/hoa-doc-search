...
function personaForMessage(m) {
  ...
  const FUNCTIONAL_INBOX = { violations: 'miranda', acc: 'annie', arc: 'annie', builders: 'annie', accounting: 'kat', ap: 'emma', payables: 'emma', resale: 'reese', estoppel: 'reese', board: 'paige' };
