  ...
  <table cellpadding="0" cellspacing="0" role="presentation" style="margin-top:18px;border-top:2px solid ${GOLD};padding-top:12px;font-family:Arial,Helvetica,sans-serif;">
    <tr>
      <td style="font-size:13px;line-height:1.5;color:${NAVY};">
        <strong style="color:${NAVY};">Katherine Reed</strong><br>
        <span style="color:${MUTED};">Accounting Manager</span><br>
        Bedrock Association Management${communityName ? ` — ${esc(communityName)}` : ''}<br>
        <a href="mailto:kat@bedrocktx.com" style="color:${NAVY};">kat@bedrocktx.com</a> <span style="color:${MUTED};">· (832) 588-2485</span>
      </td>
    </tr>
    ${logoImg ? `<tr><td style="padding-top:14px;">${logoImg}</td></tr>` : ''}
    <tr>
      <td style="padding-top:12px;font-size:11px;color:${MUTED};max-width:420px;">I'm Bedrock's AI team member for accounting. Want a person instead? Just reply and I'll pass you to the team.</td>
    </tr>
  </table>`;
}
