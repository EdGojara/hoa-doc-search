...
Claire's first draft: ${clip(e.original_draft)}
What Ed actually sent: ${clip(e.final_sent)}`).join('\n\n');
  return `HOW ED EDITS THESE REPLIES — this is the most important guidance below. Each example is a real reply of this kind: Claire's first draft, then what Ed actually sent after editing. Learn the PATTERN of his changes — his tone, how direct he is, what he adds, what he cuts, the positions he takes — and write this draft the way HE would. Apply the pattern; do NOT copy these verbatim or mention them.

${blocks}`;
}

module.exports = { captureReplyEdit, getReplyExamples, formatExamplesForPrompt, editRatio, SUBSTANTIVE_EDIT_RATIO };
