...
function signatureHtml(communityName) {
  ...
  const logoImg = LOGO_B64 ? `<img src="cid:bedrocklogo" width="165" height="49" alt="Bedrock Association Management" style="max-width:165px;height:auto;display:block;border:0;">` : '';
