...
const PROMPT_VERSION = 'meeting-intel-v2';
...
9. List EVERY motion made in open session in motions, including procedural ones (approving prior minutes, entering executive session, adjourning), even when it is also described elsewhere.
