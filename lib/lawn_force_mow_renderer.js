...
function renderForceMowLetterPdf(data) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Reset BOTH cursor axes. The contractor box positioned text with explicit
    // x offsets (COST at PAGE.margin + 350/380), which leaves doc.x parked at
    // the far right. Without resetting it, every following paragraph auto-flows
    // in a narrow right-hand column and spills across extra pages. (Scar: the
    // cleanup + force-mow letters both rendered pages 2+ as a ~1/3-width column
