...
const REMEDY_COPY = {
  ...
  tree: {
    ...
    violation_desc: 'Failure to keep the Lot in good condition, including a dead, failing, or hazardous tree that is at risk of falling and is not being maintained in a safe, healthful condition as required by the Declaration.',
    services: 'Hazardous Tree Removal and Abatement',
    reserve_sentence: 'and the Association reserves the right to take further self-help action to abate the hazardous condition without further notice if this violation continues or the condition worsens.',
  },
};
