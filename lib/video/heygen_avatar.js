...
// takes 10-20 minutes. It also refuses a freshly created group with "No valid
// image for training found", which reads like the upload failed; it did not.
// Adding the look explicitly via avatar_group/add is what makes training accept
// the group.
// ============================================================================
const fs = require('fs');
...
async function trainAvatarGroup(group_id) {
  return apiFetch('/v2/photo_avatar/train', { method: 'POST', body: JSON.stringify({ group_id }) });
}
