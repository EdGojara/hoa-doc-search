...
const ALREADY_PAID = /\b(auto.?pay|autopay|auto.?draft|autodraft)\b|successfully (charged|submitted|processed|posted|paid)|payment (was )?(charged|processed|posted|received|successful|submitted)|was (successfully )?charged|(has been|was) (drafted|debited|withdrawn)|draft(ed)? from your account|e-?check (cleared|posted)|payment confirmation|receipt of payment/i;
