...
function renderClosingParagraphs({ decision_type, community }) {
  ...
  return `<p>This approval is issued based on the specifications listed above. Any deviation from these specifications during construction — including substitutions of color, material, masonry coverage, fence type, or elevation — requires written re-approval prior to installation. Submitting a revised application through the builder portal is the cleanest path; the management team can typically turn material substitution requests in 24–48 hours.</p>
...
<style>
  ...
  .spec-block { margin: 14px 0; padding: 12px 14px;
    border: 1px solid #1A3050; border-left: 4px solid #D4AF37; background: #FAFAF6; }
  .spec-heading {
    font-family: "Times New Roman", Georgia, serif;
    font-weight: bold; font-size: 11.5pt;
    color: #1A3050; margin-bottom: 8px;
  ...
  .spec-table .spec-label {
    width: 38%; font-weight: 600; color: #1A3050;
    padding-right: 10px;
  }
  ...
  .conditions-heading {
    font-weight: bold; color: #1A3050; margin-bottom: 6px;
    letter-spacing: 0.02em;
  }
...
<div class="re-line">Re: New Construction — ${escapeHtml(reLine)}</div>
...
module.exports = { renderBuilderLetterHTML, renderMaterialSpec };
