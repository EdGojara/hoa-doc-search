...
// ocr_pdf.js
// ----------------------------------------------------------------------------
// PDF OCR fallback via Claude vision. Triggered when pdf-parse yields no text
// from a scanned image-only PDF — common for older bylaws, CC&Rs, and
// historical minutes that pre-date digital workflows.
//
// Approach: send the PDF as a `document` content block to Claude Sonnet 4.6.
...
// ocrPdfWithClaude — extract text from a scanned PDF via Claude vision.
...
async function ocrPdfWithClaude(buffer, filename) {
...
module.exports = { ocrPdfWithClaude };
