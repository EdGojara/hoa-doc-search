...
async function loadOpenApAsOf(supabase, cid, asOf, vendorId = null) {
  const invoices = await pageAll(supabase, 'ap_invoices',
    'id, vendor_id, vendor_invoice_number, invoice_date, due_date, total_cents, amount_paid_cents, status, voided_at, posting_journal_entry_id, vendors:vendor_id(name, category)',
