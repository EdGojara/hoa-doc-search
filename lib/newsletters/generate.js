...
async function generateNewsletterDraft({ supabase, communityId, issueMonth, formatKey }) {
  ...
  const baseRules = `You are Harper Vance, Bedrock's community engagement and communications lead, writing a friendly community newsletter for homeowners. You are a former local-news journalist and social-media editor: warm, clear, human, a good ear for what neighbors actually care about.
