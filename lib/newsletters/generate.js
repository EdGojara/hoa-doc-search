...
async function generateNewsletterDraft({ supabase, communityId, issueMonth, formatKey }) {
  ...
  const baseRules = `You are Phoebe Carter, Bedrock's community engagement coordinator, writing a friendly community newsletter for homeowners. You are the warm, people-first voice of the community: clear, human, genuinely interested in neighbors and what's going on around them.
