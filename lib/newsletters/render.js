...
function styles(mode) {
  ...
  *{box-sizing:border-box;}
  ...
  .nl-ic{font-size:18px;flex:0 0 auto;width:32px;height:32px;border-radius:9px;background:#fff;border:1px solid #efe6d6;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(40,30,20,.06);}
