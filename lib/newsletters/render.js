...
function styles(mode) {
  ...
  *{box-sizing:border-box;}
  ...
  /* Two-column newsletter flow on screen; single column in print so Chrome's
     paged engine paginates cleanly (multicol balances across a fixed page and
     produces overflow/blank pages). */
  .nl-content{column-count:${print ? 1 : 2};column-gap:22px;padding:22px 26px 6px;}
  .nl-section{margin:0;}
