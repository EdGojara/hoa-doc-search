...
function renderCover(s) {
  ...
  <section class="nl-cover${img ? ' has-img' : ''}"${img ? ` style="background-image:linear-gradient(180deg, rgba(11,29,52,.15), rgba(11,29,52,.78)), url('${esc(img)}');"` : ''}>
    <div class="nl-cover-inner">
      ${b.logo_url ? `<span class="nl-cover-logo"><img src="${esc(b.logo_url)}" alt=""></span>` : ''}
...
function styles(mode) {
  ...
  *{box-sizing:border-box;}
  ...
  .nl-cover-logo{display:inline-block;background:#fff;border-radius:10px;padding:8px 12px;margin-bottom:16px;box-shadow:0 6px 16px rgba(0,0,0,.18);}
  .nl-cover-logo img{height:52px;max-width:220px;object-fit:contain;display:block;}
  ...
  .nl-body p{margin:0 0 12px;} .nl-body ul{margin:0 0 12px 18px;} .nl-body ol{margin:0 0 12px 18px;} .nl-body a{color:${NAVY};}
  .nl-mdh{font-size:16px;color:${NAVY};margin:14px 0 6px;font-weight:700;}
