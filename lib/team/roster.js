...
const ROSTER = [
  ...
  {
    persona: 'phoebe', name: 'Phoebe Carter', title: 'Community engagement',
    ...
    visit: true,
    // Not an inbound email column yet — there is no community-content intake queue
    // to feed one. She is a full teammate everywhere else (colleague roster, team
    // screen, newsletter owner); flip this on when a community@ inbox exists.
    email_board: false,
  },
  {
