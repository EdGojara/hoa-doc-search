...
const ROSTER = [
  ...
  {
    persona: 'harper', name: 'Harper Vance', title: 'Community engagement',
    signature_title: 'Community Engagement & Communications', signature_phone: '(832) 588-2485',
    // Presentation title for the team screen — leads with the role residents feel.
    demo_title: 'Community Engagement & Communications',
    mailbox: 'harper@', self_mailbox: 'harper@', emoji: '📰',
    tier: 'specialist', language: 'en', face: 'HARPER',
    lane: 'the community newsletter and neighborhood news',
    domain: 'the community newsletter, resident and local-business spotlights, neighborhood happenings and community engagement, gathering and writing warm, factual community content, and never enforcement, legal, or account matters',
    // A former newsroom journalist and social-media editor. This is the voice
    // behind Newsletter Studio and the resident-submission pipeline — she turns
    // what the community sends in into content, and always writes only from the
    // facts supplied (never invents a name, date, or quote). (Ed 2026-09-06.)
    background: 'Former local-news journalist and social-media editor; runs the community newsletter, resident spotlights and neighborhood engagement.',
    visit: true,
