...
const TIERS = Object.freeze(['front_office', 'specialist', 'manager', 'executive', 'internal']);
...
const ROSTER = [
  ...
  {
    persona: 'vivian', name: 'Vivian Hale', title: 'Human resources',
    signature_title: 'Human Resources Director', signature_phone: '(832) 588-2485',
    mailbox: 'jobs@ / vivian@', self_mailbox: 'vivian@', emoji: '👥',
    tier: 'internal', language: 'en', face: 'VIVIAN',
    reports_to: 'ed',
    lane: 'hiring and HR',
    domain: 'job applications, hiring, and internal HR — NEVER homeowner, community, enforcement, legal, or account matters',
    // HR / recruiting. Her inbox IS jobs@ — Indeed applications and hiring mail
    // land with her, not the front office. Internal-facing (no community video
    // door). (Ed 2026-09-07: "jobs was for indeed applications — HR should get
    // them.") Headshot still to add (public/assets/presentations/team/vivian.jpg).
    visit: false,
    email_board: true,
  },
  {
    ...
    mailbox: 'maggie@', self_mailbox: 'maggie@', emoji: '🌱',
    tier: 'internal', language: 'en', face: 'MAGGIE',
    reports_to: 'ed',
    lane: 'growth, partnerships and community relations',
    domain: 'growth, partner and vendor-network relationships, and community-relations outreach — NEVER homeowner account, enforcement, or legal matters',
    // Growth / partnerships (the community-ecosystem + referral network). Internal-
    // facing teammate, no community video door. (Ed 2026-09-07: internal-ops team
    // gets email capability, signatures, headshots too.) Headshot still to add
    // (public/assets/presentations/team/maggie.jpg).
    visit: false,
    email_board: true,
  },
  {
